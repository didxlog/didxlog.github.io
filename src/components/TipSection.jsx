...
const TIPS = [
  ...
  {
    title: '700대, 3시간 무료주차',
    desc:  ['주차장은 FKI 타워와 공유합니다.', <br/>, '주차장 안내를 따라 컨퍼런스센터 전용', <br/>, '엘레베이터를 타고 1층으로 올라와주세요.', <br/>, '직원안내에 따라 주차등록 하시면 됩니다.'  ],
  },
  {
    title: '옆 건물 지하 1층 ATM',
    desc:  ['지하 1층 통로 혹은 외부 에스컬레이터를 통해', <br/> , 'FKI타워 지하 1층 ATM을 이용해주세요.'],
  },
  {
    title: '식사는 동시예식',
    desc:  ['2부와 식사를 함께 진행하는 동시예식 입니다.', <br/> , '빠른 식사를 원하시는 분들은 3층 연회장에 착석해주세요.'],
  },
  {
    title: '꽃포장 서비스',
    desc:  ['2부 예식 후 로비에서 꽃을 나눠드립니다.', <br/> , '부디 기분 좋은 선물이 되었으면 좋겠습니다.'],
  },
];
