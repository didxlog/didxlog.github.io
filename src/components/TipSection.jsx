...
const TIPS = [
  ...
  {
    title: 'ATM은 옆 건물 지하 1층',
    desc:  ['지하 1층 통로 혹은 외부 에스컬레이터를 통해', <br key="b1"/>, 'FKI타워 지하 1층 ATM을 이용해주세요.'],
  },
  {
    title: '식사는 동시예식',
    desc:  ['2부와 식사를 함께 진행하는 동시예식 입니다.', <br key="b1"/>, '원활한 좌석 배치를 위해', <br key="b1"/>, '참석 여부를 미리 알려주시면 감사하겠습니다.'],
  },
  {
    title: '꽃포장 서비스',
    desc:  ['2부 예식 후 로비에서 꽃을 나눠드립니다.', <br key="b1"/>, '부디 기분 좋은 선물이 되기를 바랍니다.'],
  },
];
